      ...
      <div className="w-full max-w-md bg-card rounded-3xl shadow-xl p-8 border border-border">
        ...
        <FormProvider {...methods}>
          <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-6 relative z-10">
            ...
            <Button type="submit" className="gradient-primary text-white shadow-[0_4px_14px_rgba(168,85,247,0.4)] hover:-translate-y-px hover:shadow-[0_6px_20px_rgba(168,85,247,0.5)] w-full py-3 rounded-2xl border-0">
              Sign In
            </Button>
          </form>
        </FormProvider>
        ...
        <p className="mt-8 text-center text-sm text-gray-400 relative z-10">
          ...
          <Link to="/" className="font-semibold text-primary hover:text-primary-glow transition-colors">
            Sign up
          </Link>
        </p>
      </div>
